...
export default function NotFound() {
    return (
        <div className="flex items-center justify-center h-screen bg-white dark:bg-gray-darker">
            <div className="flex flex-col">
                <svg
                    className="w-auto h-[240px] md:h-[320px] text-blue dark:text-turquoise"
                ...
                >
                    ...
                    <path
                        ...
                        fill="#2f2e41"
                    />
                    <circle cx="559" cy="744.5" r="43" fill="currentColor" />
                    <circle cx="54" cy="729.5" r="43" fill="currentColor" />
                    <circle cx="54" cy="672.5" r="31" fill="currentColor" />
                    <circle cx="54" cy="624.5" r="22" fill="currentColor" />
                </svg>
